...
export default function ListOfHrs() {
...
return (
  ...
  <table className="border-collapse w-full">
    <thead>
      <tr className="grid grid-cols-4 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-4 md:px-6 2xl:px-7.5">
